...
# Example usage of the PUBG Match Flow Testing Script
#
# This file contains example commands for testing different scenarios
# Copy and modify these examples for your own testing needs

echo "PUBG Match Flow Testing Examples"
echo "================================"
echo ""

# Example 1: Basic test with dry run (recommended for first test)
...
# Example 2: Full test with Discord posting
...
# Example 5: Custom Discord channel
